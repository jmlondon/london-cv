...
## Personal Statement
I am a wildlife biologist and my career has focused on the ecology and
conservation of seals in Alaska with a special focus on potential impacts of
climactic changes on abundance, trend, and movement ecology. Species of focus
include harbor seals and the ice-associated seals (ribbon, spotted, bearded, and
ringed seal). Research areas of interest include modeling of marine mammal
movement and behavior from deployed tags, survey design and abundance estimation
...
programming approaches (e.g. Rmarkdown) and I am increasingly focussed on open
